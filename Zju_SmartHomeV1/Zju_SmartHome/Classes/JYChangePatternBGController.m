...
@interface JYChangePatternBGController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIPopoverControllerDelegate>
...
@implementation JYChangePatternBGController
